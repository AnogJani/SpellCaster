...
function edit_dialog() {
    ...
    <div id="dialog_nav">
        ...
        <div class="edit_images_buttons">
            <img onclick="exit_general_dialog();edit_nodes(getImages(),1);" title="ערוך תמונות" class="image_btn" src="http://spellcaster.sites.airnet/PublishingImages/upper_images.png">
            <img onclick="exit_general_dialog();edit_nodes(getLinks(),1);" title="ערוך לינקים תחתונים" class="image_btn" src="http://spellcaster.sites.airnet/PublishingImages/bottomer_links.png">
        </div>
        <!--<div class="flex">
